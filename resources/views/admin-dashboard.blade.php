...
<!-- js placed at the end of the document so the pages load faster -->
    ...
    <script src="adm/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js"></script>
    <script src="adm/js/owl.carousel.js" ></script>
    <script src="adm/js/jquery.customSelect.min.js" ></script>
    ...
    <script src="adm/js/sparkline-chart.js"></script>
    <script src="adm/js/easy-pie-chart.js"></script>
    <script src="adm/js/count.js"></script>

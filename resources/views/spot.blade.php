          ...
          <div class="col-lg-12">
              <section class="panel">
                 <header class="panel-heading">
                      Titik Wifi Management
                  </header>
                  <div class="panel-body">
                    <div class="container-fluid">
                        <div class="container-fluid">
                        <span class="pull-right">
                          <a data-toggle="modal" href="#modalTambah">
                          <button class="btn btn-success">
                            <span class="fa fa-plus-circle"></span> Tambah Titik Wifi
                          </button>
                          </a>
                        </span>
                      </div>
                    ...
                    <div class="adv-table">
                      <table class="display table table-bordered table-striped" id="example">
                          ...
                          <tr>
                              ...
                              <td>{{ $spot->no_hp }}</td>
                              <td>{{ $spot->foto }}</td>
                              <td>{{ $spot->virtual_tour }}</td>
                              <td>
                                <center>
                                <button class="btn btn-primary btn-xs" data-toggle="modal" href="#modalUbah{{ $spot->id }}"><i class="fa fa-pencil"></i></button>
                                <button class="btn btn-danger btn-xs" data-toggle="modal" href="#modalHapus{{ $spot->id }}"><i class="fa fa-trash-o"></i></button>
                                </center>
                              </td>
                          </tr>
                          @endforeach
...
<!-- MODAL COLLECTIONS -->
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  ...
                  <h4 class="modal-title">Tambah Titik Wifi</h4>
              </div>
                ...
                <form class="form-horizontal" method="POST" action="{{ url('/spot') }}" enctype="multipart/form-data">
                  <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Nama Cafe</label>
                        <div class="col-sm-9">
                          <input name="nama_cafe" type="text" placeholder="" class="form-control" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Titik</label>
                        <div class="col-sm-9">
                          <input name="titik" type="text" placeholder="" class="form-control" required="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Nomor HP</label>
                        <div class="col-sm-9">
                          <input name="no_hp" type="text" placeholder="" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Link Virtual Tour</label>
                        <div class="col-sm-9">
                          <input name="virtual_tour" type="text" placeholder="" class="form-control">
                        </div>
                    </div>
  ...
  @foreach($spots as $no => $spot)
  <!-- Modal update -->
  <div class="modal fade" id="modalUbah{{ $spot->id }}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                  <h4 class="modal-title">Ubah Titik Wifi</h4>
              </div>
              <div class="modal-body">
                ...
                <form action="{{ url('/spot') }}" class="form-horizontal" method="POST">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Nama Cafe</label>
                        <div class="col-sm-9">
                          <input name="nama_cafe" type="text" placeholder="" class="form-control" required="" value="{{ $spot->nama_cafe }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Titik</label>
                        <div class="col-sm-9">
                          <input name="titik" type="text" placeholder="" class="form-control" required="" value="{{ $spot->titik }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Alamat</label>
                        <div class="col-sm-9">
                          <input name="alamat" type="text" placeholder="" class="form-control" required="" value="{{ $spot->alamat }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Nomor HP</label>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 col-sm-3 control-label">Link Virtual Tour</label>
                        <div class="col-sm-9">
                          <input name="virtual_tour" type="text" placeholder="" class="form-control" value="{{ $spot->virtual_tour }}">
                        </div>
                    </div>
  ...
  <!-- Modal Hapus -->
    <div class="modal fade" id="modalHapus{{ $spot->id }}" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form" method="POST" action="{{ url('/spot') }}">
                <input type="hidden" name="_method" value="DELETE">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <input type="hidden" name="id" value="{{ $spot->id }}">

                <center>
                    <p>Apakah anda yakin ingin menghapus titik wifi cafe <b>{{ $spot->nama_cafe }}</b>?</p>
                </center>
